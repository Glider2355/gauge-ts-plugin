...
class GaugeRerunFailedAction(componentContainer: ComponentContainer) : AbstractRerunFailedTestsAction(componentContainer) {
    ...
    private class RerunProfile(private val config: GaugeRunConfiguration) : MyRunProfile(config) {
        ...
        override fun getModules(): Array<Module> = config.modules
    }
}
